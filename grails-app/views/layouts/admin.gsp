...
<head>
	...
	<link href="${ resource(dir:"js/markitup/skins/markitup",file:"style.css") }" rel="stylesheet" type="text/css" />
	<link href="${ resource(dir:"js/markitup/sets/html",file:"style.css") }" rel="stylesheet" type="text/css" />
	<g:layoutHead />
</head>
<body>
<div class="header">
  ...
  <div class="main">
    <div class="body">
      ...
      <div class="left">
		...
		<div class="right">
			<g:render template="sideNavigation" />
		</div>
      <div class="clr"></div>
    </div>
    <div class="clr"></div>
